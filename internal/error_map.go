...
var mainErrorsDict = map[uint16][]string{
    ...
    ERR_ACCESS_DENIED_LOGIN_REQ:	{"Access denied. You must be logged in for access to this resource", "R011", "403"},
    ...
    ERR_CANT_LOGIN: 				{"Your account is trusted but you can't login at the moment. Contact with support", "R013", "401"},
